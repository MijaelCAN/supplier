            ...
            <div className="relative min-h-screen pb-8">
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <div className="relative mt-6">
                        <div
                            className="absolute -inset-4 bg-gradient-to-r from-blue-500/10 via-indigo-500/10 to-purple-500/10 rounded-3xl blur-2xl opacity-50"></div>
                        <div>
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
                                ...
                                <div className="flex-1 space-y-4">
                                    <div>
                                        ...
                                        <p className="text-lg text-gray-600 dark:text-gray-400">Departamento de Contabilidad</p>
                                    </div>
                    ...
                    <div className="mt-8 mb-32">
                        <div className="flex justify-center">
                            <div className="w-full max-w-[60%] grid grid-cols-1 md:grid-cols-2 gap-4">
                                {/* Agenda - Citas */}
                                <div
                                ...
                                >
                                    ...
                                    <span className="flex-1 text-sm font-semibold text-gray-700 dark:text-gray-300">Agenda - Citas</span>
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3 p-3 rounded-lg bg-blue-50/50 dark:bg-blue-900/20">
                                        ...
                                        <div>
                                            <p className="font-semibold text-sm text-gray-900 dark:text-white">Ver Citas de Entrega</p>
                                            <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Consultar el calendario y el detalle de cada cita programada</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3 p-3 rounded-lg bg-purple-50/50 dark:bg-purple-900/20">
                                        ...
                                        <div>
                                            <p className="font-semibold text-sm text-gray-900 dark:text-white">Visualizar Documentos</p>
                                            <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Revisar los documentos que carga el proveedor en cada cita y en facturación</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-3 p-3 rounded-lg bg-emerald-50/50 dark:bg-emerald-900/20">
                                        <ArrowDownTrayIcon className="h-5 w-5 text-emerald-600 dark:text-emerald-400 mt-0.5" />
                                        <div>
                                            <p className="font-semibold text-sm text-gray-900 dark:text-white">Descargar Documentos</p>
                                            <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Descargar los archivos cargados para su registro contable</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between p-3 rounded-lg bg-white/50 dark:bg-gray-900/50 border border-gray-200/50 dark:border-gray-700/50">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Ver Citas</span>
                                        </div>
                                    ...
                                    <div className="flex items-center justify-between p-3 rounded-lg bg-white/50 dark:bg-gray-900/50 border border-gray-200/50 dark:border-gray-700/50">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Ver Facturas</span>
                                        </div>
                                        <Chip size="sm" color="success" variant="flat">Activo</Chip>
                                    </div>
                                    <div className="flex items-center justify-between p-3 rounded-lg bg-white/50 dark:bg-gray-900/50 border border-gray-200/50 dark:border-gray-700/50">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Descargar Documentos</span>
                                        </div>
                                        <Chip size="sm" color="success" variant="flat">Activo</Chip>
                                    </div>
                                </div>
